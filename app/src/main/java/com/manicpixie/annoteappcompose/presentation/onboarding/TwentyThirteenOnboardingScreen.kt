...
@Composable
fun TwentyThirteenOnboardingScreen(
    currentPage: Int
) {
    Box(modifier = Modifier
        ...
        Column(
            ...
            Image(
                modifier = Modifier
                    .height(370.dp),
                painter = painterResource(id = R.drawable.oldtwentyfourteen),
                contentDescription = "Jetpack Compose Image"
            )
            Text(
                modifier = Modifier.padding(top = 30.dp),
                text = stringResource(id = R.string.onboarding_screen_2013_text1),
                style = TextStyle(
            ...
            Text(
                text = stringResource(id = R.string.onboarding_screen_2013_text2),
                style = TextStyle(
                    fontFamily = urbanistFont,
