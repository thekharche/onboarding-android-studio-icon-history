...
@Composable
fun TwentyFourteenOnboardingScreen(
    currentPage: Int
) {
    Box(modifier = Modifier
        ...
        Column(
            ...
            Image(
                modifier = Modifier
                    .height(370.dp),
                painter = painterResource(id = R.drawable.newtwentyfourteen),
                contentDescription = "Jetpack Compose Image"
            )
            Text(
                modifier = Modifier.padding(top = 30.dp),
                text = stringResource(id = R.string.onboarding_screen_2014_text1),
                style = TextStyle(
            ...
            Text(
                text = stringResource(id = R.string.onboarding_screen_2014_text2),
                style = TextStyle(
                    fontFamily = urbanistFont,
