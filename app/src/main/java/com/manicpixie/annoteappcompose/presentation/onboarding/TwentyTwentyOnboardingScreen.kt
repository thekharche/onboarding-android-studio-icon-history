...
@Composable
fun TwentyTwentyOnboardingScreen(
    currentPage: Int
) {
    Box(modifier = Modifier
        ...
        Column(
            ...
            Image(
                modifier = Modifier
                    .height(370.dp),
                painter = painterResource(id = R.drawable.twentytwenty),
                contentDescription = "Jetpack Compose Image"
            )
            Text(
                modifier = Modifier.padding(top = 30.dp),
                text = stringResource(id = R.string.onboarding_screen_2020_text1),
                style = TextStyle(
            ...
            Text(
                text = stringResource(id = R.string.onboarding_screen_2020_text2),
                style = TextStyle(
                    fontFamily = urbanistFont,
